...
const Tentang = () => {
  return (
    <>
      <Navbar />
      <div className="max-w-4xl mx-auto px-4 py-10 text-gray-800 pt-20">
        ...
        <section className="mb-8">
          ...
          <p>
            GrowPrice adalah platform komunitas untuk memantau harga item dalam
            game Growtopia, layaknya pasar saham. Kami mencatat harga jual dan
            beli dari berbagai item, lengkap dengan grafik pergerakan harian.
          </p>
        </section>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold mb-2">Kenapa Kami Buat Ini?</h2>
          <p>
            Sebagai pemain Growtopia, kami merasa sulit melacak pergerakan harga
            item secara akurat. Maka dari itu, GT Market hadir untuk menyediakan
            data harga yang transparan, agar keputusan jual beli bisa lebih
            bijak.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            stabilitas ekonomi in-game. Jika kamu punya masukan, hubungi kami di{" "}
            <a
